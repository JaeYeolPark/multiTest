...
<section id="content">
	...
	test33333333333333333333333333
	test44444444444444444444444444

	<h3>회원가입</h3>
	<!-- REST API 키 =  client_id -->
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=de8b947c7781a8c06597b232983a087b&redirect_uri=http://localhost/mvc/member/enroll/kakao">
		<img src="${path}/resources/images/kakao_login_medium_narrow.png" >
	</a>
	<br>
	
	<h3>로그인</h3>
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=de8b947c7781a8c06597b232983a087b&redirect_uri=http://localhost/mvc/kakaoLogin">
